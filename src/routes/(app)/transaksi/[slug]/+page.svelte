<script>
  ...
  const handleBayar = () => {
    Swal.fire({
      title: 'Bayar Perawatan Pasien?',
      text: 'Mohon berhati-hati, aksi ini bersifat permanen pada database.',
      showDenyButton: true,
      showCancelButton: false,
      confirmButtonText: 'Ubah Status Nota Telah di Bayar',
    ...
    <div class="px-4 py-6 bg-gray-50 dark:bg-gray-800 shadow rounded-lg">
      <div class="flex items-center flex-wrap sm:flex-nowrap justify-center sm:justify-between">
        ...
        <div class="flex items-center justify-between gap-4">
          ...
          <Button color="yellow" class="w-fit" size="xs">
            <svg xmlns="http://www.w3.org/2000/svg" class="sm:mr-2" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M18 7H6V3h12v4Zm0 5.5q.425 0 .713-.288T19 11.5q0-.425-.288-.713T18 10.5q-.425 0-.713.288T17 11.5q0 .425.288.713T18 12.5ZM16 19v-4H8v4h8Zm2 2H6v-4H2v-6q0-1.275.875-2.138T5 8h14q1.275 0 2.138.863T22 11v6h-4v4Z"/></svg><span class="hidden sm:block">Download</span></Button>
          <Button color="purple" on:click={handleBayar} class="w-fit" size="xs">
            <svg xmlns="http://www.w3.org/2000/svg" class="sm:mr-2" width="24" height="24" viewBox="0 0 256 256"><path fill="currentColor" d="M216 74H56a10 10 0 0 1 0-20h136a6 6 0 0 0 0-12H56a22 22 0 0 0-22 22v128a22 22 0 0 0 22 22h160a14 14 0 0 0 14-14V88a14 14 0 0 0-14-14Zm2 126a2 2 0 0 1-2 2H56a10 10 0 0 1-10-10V83.59A21.84 21.84 0 0 0 56 86h160a2 2 0 0 1 2 2Zm-28-60a10 10 0 1 1-10-10a10 10 0 0 1 10 10Z"/></svg><span class="hidden sm:block">Bayar</span></Button>
        </div>
      </div>
      <hr class="my-2 lg:my-4">
      <div class="text-center p-4">
        <p class="text-md sm:text-xl lg:text-2xl font-bold">Rincian Biaya Perawatan</p>
        <p class="text-sm sm:text-md lg:text-xl font-semibold">Periode Perawatan: 8 April 2023 s/d 9 April 2023</p>
      </div>
      ...
      <div class="text-xs lg:text-lg grid grid-cols-1 sm:grid-cols-2 gap-6 py-4 font-medium">
        <div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>Dokter Utama</div>
            <div>: dr. Khal Drogo, Sp PD FINASIM</div>
          </div>
        </div>
        <div>
          <div class="grid grid-cols-2 gap-4">
      ...
      <div class="my-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base py-2">
          ...
          <div>08-04-2023</div>
          <div>Kelas VVIP</div>
          <div class="sm:text-right">20,000.00</div>
          <div>1</div>
          <div>0.00</div>
          <div class="sm:text-right border-b border-dashed border-slate-600">20,000.00</div>
        </div>
      ...
      <div class="my-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base py-2">
          ...
          <div>08-04-2023</div>
          <div>Kelas VVIP</div>
          <div class="sm:text-right">2,500,000.00</div>
          <div>1</div>
          <div>0.00</div>
          <div class="sm:text-right border-b border-dashed border-slate-600">2,500,000.00</div>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base">
          <div>Kamar Ayodya</div>
          <div>09-04-2023</div>
          <div>Kelas VVIP</div>
          <div class="sm:text-right">2,500,000.00</div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-medium py-2">
          ...
          <div class="sm:text-right border-b border-dashed border-slate-600">5,000,000.00</div>
        </div>
      </div>
      <div class="my-2">
        ...
        <div class="py-1">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base py-2">
            ...
            <div>08-04-2023</div>
            <div>Kelas VVIP</div>
            <div class="sm:text-right">100,000.00</div>
            <div>1</div>
            <div>0.00</div>
            <div class="sm:text-right border-b border-dashed border-slate-600">100,000.00</div>
          </div>
        </div>
        <div class="py-1">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-medium py-2">
          ...
          <div class="sm:text-right border-b border-dashed border-slate-600">300,000.00</div>
        </div>
      </div>
      <div class="my-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base py-2">
          ...
          <div>08-04-2023</div>
          <div>Kelas VVIP</div>
          <div class="sm:text-right">50,000.00</div>
          <div>1</div>
          <div>0.00</div>
          <div class="sm:text-right border-b border-dashed border-slate-600">50,000.00</div>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-medium py-2">
          <div class="sm:text-right col-span-6">Total Obat & Bahan Habis Pakai</div>
          <div class="sm:text-right border-b border-dashed border-slate-600">100,000.00</div>
        </div>
      </div>
      <div class="my-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base py-2">
          ...
          <div>08-04-2023</div>
          <div>Kelas VVIP</div>
          <div class="sm:text-right">150,000.00</div>
          <div>1</div>
          <div>0.00</div>
          <div class="sm:text-right border-b border-dashed border-slate-600">150,000.00</div>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-base">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-xs lg:text-lg font-medium py-2">
          <div class="sm:text-right col-span-6">Total Tindakan Medis</div>
          <div class="sm:text-right border-b border-dashed border-slate-600">200,000.00</div>
        </div>
      </div>
      <hr class="my-2 border-slate-600">
      <div class="grid grid-cols-1 sm:grid-cols-7 gap-4 text-sm lg:text-lg font-semibold">
        ...
        <div class="sm:col-span-3 lg:col-span-1 sm:text-right">5,420,000.00</div>
      </div>
    </div>
  </section>
</div>