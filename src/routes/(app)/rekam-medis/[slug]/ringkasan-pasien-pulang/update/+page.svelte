              ...
              <div class="grouphelperPagination sm:col-span-2">
                {#each diagnosaUtama as tag, i}
                  <div class="flex flex-wrap sm:flex-nowrap gap-4 py-2">
                    ...
                    <Button on:click={() => deleteDiagnosaUtama(i)} size="xs" class="w-full sm:w-24" color="red"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM18 4h-2.5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1z"/></svg></Button>
                  </div>
                {/each}
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 py-2">
              <div class="grouphelperPagination sm:col-span-2">
                ...
                <div class="flex flex-wrap sm:flex-nowrap gap-4 py-2">
                    ...
                    <Button on:click={() => deleteDiagnosaSekunder(i)} class="w-full sm:w-24" size="xs" color="red"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM18 4h-2.5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1z"/></svg></Button>
                  </div>
                {/each}
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 py-2">
              <div class="grouphelperPagination sm:col-span-2 flex gap-4">
                ...
                <Button size="md" on:click={addTindakan}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="sm:mr-2" viewBox="0 0 24 24"><path fill="currentColor" d="M11 17h2v-4h4v-2h-4V7h-2v4H7v2h4v4Zm1 5q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Z"/></svg><span class="hidden sm:block"> Tindakan</span>
                </Button>
              </div>
              <div class="grouphelperPagination sm:col-span-2">
                {#each tindakan as tag, i}
                  <div class="flex flex-wrap sm:flex-nowrap gap-4 py-2">
                    ...
                    <Button on:click={() => deleteTindakan(i)} size="xs" class="w-full sm:w-24" color="red"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM18 4h-2.5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1z"/></svg></Button>
                  </div>
                {/each}
              </div>
            </div>
        ...
        <div class="my-2">
          <div class="flex mb-2 gap-4 justify-between items-center">
            ...
            <Button size="md" on:click={addEdukasi}>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="sm:mr-2" viewBox="0 0 24 24"><path fill="currentColor" d="M11 17h2v-4h4v-2h-4V7h-2v4H7v2h4v4Zm1 5q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Z"/></svg><span class="hidden sm:block"> Edukasi</span>
            </Button>
          </div>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 py-2">
            <div class="grouphelperPagination sm:col-span-2">
              {#each edukasi as tag, i}
                <div class="flex flex-wrap sm:flex-nowrap gap-4 py-2">
                  ...
                  <Button on:click={() => deleteEdukasi(i)} size="xs" class="w-full sm:w-24" color="red"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM18 4h-2.5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1z"/></svg></Button>
                </div>
              {/each}
            </div>
          </div>
