...
<main>
  <div class="flex items-center justify-between">
    ...
    <Button href="ringkasan-pasien-pulang/update" color="green">
  ...
  <div class="overflow-y-auto max-h-screen">
    <div class="border border-slate-300 rounded p-4 w-full">
      <div class="mb-2">
        <p class="text-lg font-semibold italic">Ringkasan Informasi</p>
        <div class="grid grid-cols-2 gap-6 py-2">
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
            <p class="font-medium">Tanggal Masuk:</p>
            <p class="font-light text-right">Minggu, 9 April 2023</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
            <p class="font-medium">Tanggal Keluar:</p>
            <p class="font-light text-right">Senin, 10 April 2023</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium col-span-2">Cara Pembayaran:</p>
            <div class="grid grid-cols-2 gap-4 cols-span-2">
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium col-span-2">Dokter Penanggung Jawab Pasien:</p>
            <div class="grid grid-cols-2 gap-4 cols-span-2">
              <p class="font-medium">DPJP Utama:</p>
              <p class="font-light text-right">dr. Khal Drogo, Sp PD FINASIM</p>
            </div>
            <div class="grid grid-cols-2 gap-4 cols-span-2">
              <p class="font-medium">Tim Dokter:</p>
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium">Indikasi Rawat Inap / Diagnosis Masuk:</p>
            <p class="font-light text-right">Lorem ipsum dolor sit amet.</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium">Hasil Pemeriksaan Penunjang:</p>
            <p class="font-light text-right">Lorem ipsum dolor sit amet.</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium">Diagnosa Utama:</p>
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium">Diagnosa Sekunder:</p>
            <div class="font-light text-right">
              <div class="my-1">
                  <p>ICD-10 Code: AA.1</p>
                  <p>Deskripsi: Pilek</p>
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
            <p class="font-medium">Terapi Selama Dirawat:</p>
            <p class="font-light text-right">Lorem ipsum</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
            <p class="font-medium">Terapi Dirumah:</p>
            <p class="font-light text-right">Lorem ipsum</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium">Tindakan/Operasi yang Sudah Dilakukan:</p>
            <div class="font-light text-right">
              <div class="my-1">
                  <p>ICD-9 Code: AA.1</p>
      ...
      <div class="mb-2">
        <p class="text-lg font-semibold italic">Kondisi Pasien Pulang (<span class="italic">Status Present</span>)</p>
        <div class="grid grid-cols-2 gap-6 py-2">
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium col-span-2">Keadaan Umum/GCS:</p>
            <div class="grid grid-cols-3 gap-4 col-span-2">
              <div class="grid grid-cols-2 gap-4">
                <p class="font-medium">T:</p>
                <p class="font-light text-right">10 mmHg</p>
              </div>
              <div class="grid grid-cols-2 gap-4">
                <p class="font-medium">N:</p>
                <p class="font-light text-right">10 x/menit</p>
              </div>
              <div class="grid grid-cols-2 gap-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <p class="font-light text-right">10 C</p>
              </div>
              <div class="grid grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
            <p class="font-medium">Cara Pulang:</p>
            <p class="font-light text-right">Atas Permintaan Pasien</p>
          </div>
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm">
            <p class="font-medium">Keadaan Pulang:</p>
            <p class="font-light text-right">Sembuh</p>
          </div>
        </div>
      </div>
      <div class="mb-2">
        <p class="text-lg font-semibold italic">Instruksi Tindakan Lanjut</p>
        <div class="grid grid-cols-2 gap-6 py-2">
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium col-span-2">Kontrol di RSI Aisyah Malang:</p>
            <div class="grid grid-cols-2 gap-4">
              <p class="font-medium">Poliklinik:</p>
              <p class="font-light text-right">Lorem Ipsum</p>
            </div>
            <div class="grid grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium col-span-2">Rujuk / Rujuk Balik di Luar RSI Aisyah Malang:</p>
            <div class="grid grid-cols-2 gap-4">
      ...
      <div class="mb-2">
        <p class="text-lg font-semibold italic">Edukasi</p>
        <div class="grid grid-cols-2 gap-6 py-2">
          <div class="grid grid-cols-2 gap-6 border p-4 text-sm col-span-2">
            <p class="font-medium">Daftar Edukasi Pasien:</p>
