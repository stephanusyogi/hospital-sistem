...
<main>
  ...
  <Table hoverable={true} shadow>
    <TableHead>
      ...
      <TableHeadCell class="text-center">Profesional Pemberi Asuhan(PPA)</TableHeadCell>
      <TableHeadCell class="text-center">Identitas PPA</TableHeadCell>
      <TableHeadCell class="text-center">Verifikasi DPJP</TableHeadCell>
    </TableHead>
    <TableBody> 
      {#each dummyCatatan as { tgl_jam, ppa, hasil, instruksi, dpjp, identitas_ppa }}
