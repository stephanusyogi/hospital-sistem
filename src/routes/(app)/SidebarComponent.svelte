<script>
  ...
  let aClass =
    "my-2 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700";
  let btnClass =
    "my-2 flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700";
  let site = {
...
<Sidebar
  asideClass="{openSideBar
    ? 'w-80'
    : 'w-24'} relative hidden sm:block transition-width transition-slowest ease bg-gray-50 rounded dark:bg-gray-800"
>
  <SidebarWrapper
  ...
  >
    <SidebarBrand
      ...
      spanClass="{openSideBar
        ? ''
        : 'hidden'} self-center font-semibold whitespace-nowrap dark:text-white text-sm sm:text-md lg:text-lg xl:text-xl"
    />
  </SidebarWrapper>
  <SidebarWrapper
    divClass="mt-5 overflow-y-auto max-h-screen pb-4 px-3 bg-gray-50 rounded dark:bg-gray-800"
  >
    {#if user_data?.role === "Perawat"}
      <SidebarGroup ulClass="space-y-2">
        ...
        <div
          ...
          on:mouseleave={() => {
            openSideBar ? (openSideBar = true) : (openSideBar = false);
          }}
        >
          <SidebarItem
  ...
  <div
    class="cursor-pointer py-6 absolute top-[100px] -right-7 text-gray-700 z-40 bg-gray-50 rounded-br-lg rounded-tr-lg dark:bg-gray-800"
    on:click={() => {
      openSideBar ? (openSideBar = false) : (openSideBar = true);
    }}
  >
    {#if openSideBar}
      <Icon
