...
<div class="overflow-y-auto relative max-h-screen p-6 sm:p-10 space-y-6">
  ...
  <section class="px-4 py-6 bg-gray-50 dark:bg-gray-800 shadow rounded-lg">
    <div class="flex items-center justify-between">
      <p class="text-lg sm:text-md lg:text-2xl font-semibold">Update Informasi Dokter</p>
    </div>
    <hr class="my-5">
    <form on:submit|preventDefault={handleSubmit}>
      ...
      <div class="group mb-4">
        ...
        <Input id="password" name="password" type="password" placeholder="Isi apabila ingin mengubah password akun"/>
      </div>
