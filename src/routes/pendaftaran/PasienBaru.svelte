<script>
  ...
  import { Button, Checkbox, Input, Label, Radio, Search, Select, Textarea } from "flowbite-svelte";
...
<section>
  <form on:submit|preventDefault={handleSubmitPendaftaranPasienBaru}>
    ...
    <div class="text-right">
      <Button type="submit" color="green">Daftarkan & Lanjutkan ke Pendaftaran Rawat Inap</Button>
    </div>
  </form>
</section>