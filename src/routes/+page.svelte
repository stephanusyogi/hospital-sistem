<script>
  ...
  import bg_dashboard from "$lib/images/dashboard.jpg"
</script>
    ...
    <div class="px-4 py-2 bg-gray-50 dark:bg-gray-800 shadow rounded-lg">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="bg-white grid grid-cols-3 shadow rounded-lg">
            ...
            <div class="p-8 flex items-center">
              <div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-lime-600 bg-lime-100 rounded-full mr-6">
            ...
            <div class="p-8 flex items-center">
              <div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-rose-600 bg-rose-100 rounded-full mr-6">
