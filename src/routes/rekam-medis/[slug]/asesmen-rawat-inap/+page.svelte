  ...
  <Tabs style="underline" defaultClass="flex space-x-2">
    <TabItem open title="Bagian 1: Informasi">
      <Accordion>
        ...
        <AccordionItem>
          <span slot="header">Pemeriksaan Muskuloskeletal & Kulit (Mobilitas, Fungsi Sendi, Warna Kulit, Turgor)itourinaria <span class="text-sm text-red-500 italic">*</span></span>
          <div class="grid grid-cols-4 gap-4">
            <div class="my-2">
        ...
        <AccordionItem>
          ...
          <div class="grid grid-cols-4 gap-4 my-5">
            <div class="my-2">
              ...
              <div class="flex flex-wrap gap-2">
                <Radio name="aktivitas_makanminum" value="1">Mandiri</Radio>
                <Radio name="aktivitas_makanminum" value="2">100% Dibantu</Radio>
              </div>
            </div>
            <div class="my-2">
              <Label for="" class="mb-2">Mandi: <span class="text-sm text-red-500 italic">*</span></Label>
              <div class="flex flex-wrap gap-2">
                <Radio name="aktivitas_mandi" value="1">Mandiri</Radio>
                <Radio name="aktivitas_mandi" value="2">100% Dibantu</Radio>
              </div>
            </div>
            <div class="my-2">
              <Label for="" class="mb-2">Memakai Baju: <span class="text-sm text-red-500 italic">*</span></Label>
              <div class="flex flex-wrap gap-2">
                <Radio name="aktivitas_baju" value="1">Mandiri</Radio>
                <Radio name="aktivitas_baju" value="2">100% Dibantu</Radio>
              </div>
            </div>
            <div class="my-2">
              <Label for="" class="mb-2">BAB/BAK (Pergi ke toilet): <span class="text-sm text-red-500 italic">*</span></Label>
              <div class="flex flex-wrap gap-2">
                <Radio name="aktivitas_toilet" value="1">Mandiri</Radio>
                <Radio name="aktivitas_toilet" value="2">100% Dibantu</Radio>
              </div>
            </div>
            <div class="my-2">
              <Label for="" class="mb-2">Naik turun tempat tidur: <span class="text-sm text-red-500 italic">*</span></Label>
              <div class="flex flex-wrap gap-2">
                <Radio name="aktivitas_tidur" value="1">Mandiri</Radio>
                <Radio name="aktivitas_tidur" value="2">100% Dibantu</Radio>
              </div>
            </div>
            <div class="my-2">
              <Label for="" class="mb-2">Kemampuan menahan BAB/BAK: <span class="text-sm text-red-500 italic">*</span></Label>
              <div class="flex flex-wrap gap-2">
                <Radio name="aktivitas_menahan" value="1">Mandiri</Radio>
                <Radio name="aktivitas_menahan" value="2">100% Dibantu</Radio>
              </div>
            </div>
          </div>
        </AccordionItem>
