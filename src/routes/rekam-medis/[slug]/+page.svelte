...
<div>
  <div class="flex flex-wrap items-centere justify-between">
    <div>
      ...
      <p class="font-base italic text-md">DRM - Catatan Perkembangan Pasien Terintegrasi</p>
    </div>
    <div>
      <Button color="green" href="/rekam-medis/{no_rm}/catatan-perkembangan-pasien-terintegrasi">Lihat Aktivitas Selengkapnya</Button>
    </div>
  </div>
</div>
